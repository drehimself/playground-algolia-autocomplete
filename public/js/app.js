...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./node_modules/@algolia/autocomplete-core/dist/esm/utils/isOrContainsNode.js");
  ...
  var getEnvironmentProps = function getEnvironmentProps(providedProps) {
    ...
    return _objectSpread({
      ...
      onTouchStart: function onTouchStart(event) {
        ...
        var isNotAutocompleteInteraction = store.getState().isOpen === false && !_onInput__WEBPACK_IMPORTED_MODULE_0__.onInput.isRunning();
        ...
        var isTargetWithinAutocomplete = [formElement, panelElement].some(function (contextNode) {
          return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.isOrContainsNode)(contextNode, event.target);
        });
        ...
        if (isTargetWithinAutocomplete === false) {
          ...
          if (!props.debug && _onInput__WEBPACK_IMPORTED_MODULE_0__.onInput.isRunning()) {
  ...
  var getInputProps = function getInputProps(providedProps) {
    function onFocus(event) {
      ...
      if (props.openOnFocus || Boolean(store.getState().query)) {
        (0,_onInput__WEBPACK_IMPORTED_MODULE_0__.onInput)(_objectSpread({
          event: event,
          props: props,
  ...
  var getItemProps = function getItemProps(providedProps) {
    ...
    return _objectSpread({
      ...
      onClick: function onClick(event) {
        ...
        var runPreCommand = itemUrl ? Promise.resolve() : (0,_onInput__WEBPACK_IMPORTED_MODULE_0__.onInput)(_objectSpread({
          event: event,
          nextState: {
            isOpen: false
          },
...
function onInput(_ref) {
  ...
  return runConcurrentSafePromise(props.getSources(_objectSpread({
    ...
    var highlightedItem = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getActiveItem)(store.getState());
...
function onKeyDown(_ref) {
  ...
  if (event.key === 'ArrowUp' || event.key === 'ArrowDown') {
    ...
    if (_onInput__WEBPACK_IMPORTED_MODULE_1__.onInput.isRunning()) {
      store.shouldSkipPendingUpdate = true;
    }
...
/* harmony export */ });
/* harmony import */ var _algolia_autocomplete_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @algolia/autocomplete-core */ "./node_modules/@algolia/autocomplete-core/dist/esm/createAutocomplete.js");
/* harmony import */ var _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @algolia/autocomplete-shared */ "./node_modules/@algolia/autocomplete-shared/dist/esm/createRef.js");
/* harmony import */ var _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @algolia/autocomplete-shared */ "./node_modules/@algolia/autocomplete-shared/dist/esm/getItemsCount.js");
/* harmony import */ var _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @algolia/autocomplete-shared */ "./node_modules/@algolia/autocomplete-shared/dist/esm/debounce.js");
/* harmony import */ var _createAutocompleteDom__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./createAutocompleteDom */ "./node_modules/@algolia/autocomplete-js/dist/esm/createAutocompleteDom.js");
/* harmony import */ var _createEffectWrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createEffectWrapper */ "./node_modules/@algolia/autocomplete-js/dist/esm/createEffectWrapper.js");
/* harmony import */ var _createReactiveWrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createReactiveWrapper */ "./node_modules/@algolia/autocomplete-js/dist/esm/createReactiveWrapper.js");
/* harmony import */ var _getDefaultOptions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getDefaultOptions */ "./node_modules/@algolia/autocomplete-js/dist/esm/getDefaultOptions.js");
/* harmony import */ var _getPanelPlacementStyle__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./getPanelPlacementStyle */ "./node_modules/@algolia/autocomplete-js/dist/esm/getPanelPlacementStyle.js");
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./render */ "./node_modules/@algolia/autocomplete-js/dist/esm/render.js");
/* harmony import */ var _userAgents__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./userAgents */ "./node_modules/@algolia/autocomplete-js/dist/esm/userAgents.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils */ "./node_modules/@algolia/autocomplete-js/dist/esm/utils/setProperties.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils */ "./node_modules/@algolia/autocomplete-js/dist/esm/utils/mergeDeep.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
function autocomplete(options) {
  var _createEffectWrapper = (0,_createEffectWrapper__WEBPACK_IMPORTED_MODULE_0__.createEffectWrapper)(),
      runEffect = _createEffectWrapper.runEffect,
      cleanupEffects = _createEffectWrapper.cleanupEffects,
      runEffects = _createEffectWrapper.runEffects;

  var _createReactiveWrappe = (0,_createReactiveWrapper__WEBPACK_IMPORTED_MODULE_1__.createReactiveWrapper)(),
      reactive = _createReactiveWrappe.reactive,
      runReactives = _createReactiveWrappe.runReactives;

  var hasNoResultsSourceTemplateRef = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_2__.createRef)(false);
  var optionsRef = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_2__.createRef)(options);
  var onStateChangeRef = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_2__.createRef)(undefined);
  var props = reactive(function () {
    return (0,_getDefaultOptions__WEBPACK_IMPORTED_MODULE_3__.getDefaultOptions)(optionsRef.current);
  });
  var isDetached = reactive(function () {
    return props.value.core.environment.matchMedia(props.value.renderer.detachedMediaQuery).matches;
  });
  var autocomplete = reactive(function () {
    return (0,_algolia_autocomplete_core__WEBPACK_IMPORTED_MODULE_4__.createAutocomplete)(_objectSpread(_objectSpread({}, props.value.core), {}, {
      onStateChange: function onStateChange(params) {
      ...
      shouldPanelOpen: optionsRef.current.shouldPanelOpen || function (_ref) {
        ...
        var hasItems = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_5__.getItemsCount)(state) > 0;
      ...
      __autocomplete_metadata: {
        userAgents: _userAgents__WEBPACK_IMPORTED_MODULE_6__.userAgents,
        options: options
      }
    }));
  });
  var lastStateRef = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_2__.createRef)(_objectSpread({
    collections: [],
    completion: null,
    context: {},
    isOpen: false,
  ...
  var dom = reactive(function () {
    return (0,_createAutocompleteDom__WEBPACK_IMPORTED_MODULE_7__.createAutocompleteDom)({
  ...
  function setPanelPosition() {
    (0,_utils__WEBPACK_IMPORTED_MODULE_8__.setProperties)(dom.value.panel, {
      style: isDetached.value ? {} : (0,_getPanelPlacementStyle__WEBPACK_IMPORTED_MODULE_9__.getPanelPlacementStyle)({
  ...
  function scheduleRender(state) {
    ...
    var render = !(0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_5__.getItemsCount)(state) && !hasNoResultsSourceTemplateRef.current && props.value.renderer.renderNoResults || props.value.renderer.render;
    (0,_render__WEBPACK_IMPORTED_MODULE_10__.renderSearchBox)(renderProps);
    (0,_render__WEBPACK_IMPORTED_MODULE_10__.renderPanel)(render, renderProps);
  }
  ...
  runEffect(function () {
    ...
    (0,_utils__WEBPACK_IMPORTED_MODULE_8__.setProperties)(props.value.core.environment, environmentProps);
    return function () {
      (0,_utils__WEBPACK_IMPORTED_MODULE_8__.setProperties)(props.value.core.environment, Object.keys(environmentProps).reduce(function (acc, key) {
  ...
  runEffect(function () {
    var debouncedRender = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_11__.debounce)(function (_ref2) {
  ...
  runEffect(function () {
    var onResize = (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_11__.debounce)(function () {
  ...
  function update() {
    ...
    cleanupEffects();
    optionsRef.current = (0,_utils__WEBPACK_IMPORTED_MODULE_12__.mergeDeep)(props.value.renderer, props.value.core, {
...
/* harmony export */ });
/* harmony import */ var _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @algolia/autocomplete-shared */ "./node_modules/@algolia/autocomplete-shared/dist/esm/invariant.js");
/* harmony import */ var _algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @algolia/autocomplete-shared */ "./node_modules/@algolia/autocomplete-shared/dist/esm/generateAutocompleteId.js");
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components */ "./node_modules/@algolia/autocomplete-js/dist/esm/components/Highlight.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components */ "./node_modules/@algolia/autocomplete-js/dist/esm/components/ReverseHighlight.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components */ "./node_modules/@algolia/autocomplete-js/dist/esm/components/ReverseSnippet.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components */ "./node_modules/@algolia/autocomplete-js/dist/esm/components/Snippet.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils */ "./node_modules/@algolia/autocomplete-js/dist/esm/utils/mergeClassNames.js");
...
var defaultRender = function defaultRender(_ref, root) {
  ...
  (0,preact__WEBPACK_IMPORTED_MODULE_0__.render)(children, root);
};
...
function getDefaultOptions(options) {
  ...
  var defaultComponents = {
    Highlight: (0,_components__WEBPACK_IMPORTED_MODULE_3__.createHighlightComponent)(defaultedRenderer),
    ReverseHighlight: (0,_components__WEBPACK_IMPORTED_MODULE_4__.createReverseHighlightComponent)(defaultedRenderer),
    ReverseSnippet: (0,_components__WEBPACK_IMPORTED_MODULE_5__.createReverseSnippetComponent)(defaultedRenderer),
    Snippet: (0,_components__WEBPACK_IMPORTED_MODULE_6__.createSnippetComponent)(defaultedRenderer)
  };
  ...
  return {
    renderer: {
      classNames: (0,_utils__WEBPACK_IMPORTED_MODULE_7__.mergeClassNames)(defaultClassNames, classNames !== null && classNames !== void 0 ? classNames : {}),
    ...
    core: _objectSpread(_objectSpread({}, core), {}, {
      id: (_core$id = core.id) !== null && _core$id !== void 0 ? _core$id : (0,_algolia_autocomplete_shared__WEBPACK_IMPORTED_MODULE_8__.generateAutocompleteId)(),
      environment: environment
    })
  };
}
...
var searchClient = algoliasearch_lite__WEBPACK_IMPORTED_MODULE_1___default()('latency', // APP ID
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/@algolia/autocomplete-theme-classic/dist/theme.min.css":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/@algolia/autocomplete-theme-classic/dist/theme.min.css ***!
  \***************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_theme_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!../../../postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./theme.min.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/@algolia/autocomplete-theme-classic/dist/theme.min.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_theme_min_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_theme_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
